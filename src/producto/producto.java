...
public class producto {
    ...
    int categoria_id;      // 1=electronica, 2=ropa, ...

    public producto() {}

    public producto(int id, String nombre, double precio, double Costo_Unitario,
                    int cantidad, int cantidad_minima, int categoria_id) {
        this.id = id;
        this.nombre = nombre;
        this.precio = precio;
